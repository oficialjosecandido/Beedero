...
export default function Home() {
  return (
    <main className="min-h-screen bg-beedero-black text-beedero-white">
      ...
      <footer className="flex flex-col items-center gap-3 px-5 py-10 text-xs font-medium uppercase tracking-[0.1em] text-beedero-black/40 sm:flex-row sm:justify-between sm:px-8">
