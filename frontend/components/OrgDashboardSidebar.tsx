    ...
    <aside className="flex flex-col gap-4">
      <div className="rounded-3xl border-2 border-beedero-border bg-beedero-white p-5 shadow-sm">
        ...
        <div className="mt-5 border-t border-dashed border-beedero-border pt-5">
          <p className="text-xs font-bold uppercase tracking-[0.12em] text-zinc-400">Coming soon</p>
          <ul className="mt-3 flex flex-col gap-1">
            {COMING_SOON.map((item) => (
              <li
                key={item.label}
                className="flex items-start justify-between gap-2 rounded-xl px-2 py-2 text-zinc-400"
              >
