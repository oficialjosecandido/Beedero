  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative rounded-full px-3 py-2 text-sm font-semibold text-beedero-black/65 hover:bg-beedero-yellow hover:text-beedero-black"
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-2 w-80 rounded-2xl border border-beedero-black/10 bg-beedero-white p-3 shadow-lg">
